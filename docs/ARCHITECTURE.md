...
- **Non-Destructive Mask Engine**: The UI features an advanced WebGL pipeline leveraging a dual-texture system (`baseMaskRenderTexture`). This allows users to manually restore/erase mask edges using a customized brush.
